...
export default async function handler(req, res) {
  ...
  // Керівник компанії
  if (userMessage.includes('керівник') || userMessage.includes('директор') || userMessage.includes('сео') || userMessage.includes('шеф') || userMessage.includes('CEO') || userMessage.includes('головний')) {

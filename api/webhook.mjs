...
const VIDZONE_PATTERNS = [
  ...
  /\bкампані(?:я|ї|ю|ями|ях)\b/i, /\bрозміщенн\w*\b/i, /\bреклам\w*\b/i   /\bшкодкін\b/i, /\bєвген левченко\b/i,
  /\bfmcg\b/i, /\bрите?йл\b/i, /\bretail\b/i,
  /\bкейс\w*\b/i, /\bбренд\w*\b/i, /\bкампані\w*\b/i, /\bрозміщенн\w*\b/i, /\bреклам\w*\b/i,
